  ...
  return showPlaylistModalDialog<PlaylistCreationMode>(
    ...
    builder: (dialogContext) {
      ...
      return _PlaylistModalScaffold(
        title: dialogL10n.playlistCreationModeTitle,
        body: Column(
          ...
          children: [
            _PlaylistCreationModeOption(
              ...
              title: dialogL10n.playlistCreationModeLocalTitle,
              description: dialogL10n.playlistCreationModeLocalDescription,
              onTap: () =>
            ...
            _PlaylistCreationModeOption(
              ...
              title: dialogL10n.playlistCreationModeCloudTitle,
              description: dialogL10n.playlistCreationModeCloudDescription,
              onTap: () =>
      ...
      body: Column(
        ...
        children: [
          ...
          _ModalTextField(
            ...
            label: l10n.playlistCreationCloudIdLabel,
            hintText: l10n.playlistCreationCloudIdHint,
            enabled: true,
            onChanged: (_) {
              if (_errorText != null) {
...
class _PlaylistCreationDialogState extends State<_PlaylistCreationDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final l10n = context.l10n;
    final dialogTitle =
        isEditing ? l10n.playlistEditorTitleEdit : l10n.playlistEditorTitleCreate;
    final playlist = widget.initialPlaylist;
    ...
    return _PlaylistModalScaffold(
      ...
      body: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 6),
                    _SheetActionButton.secondary(
                      label: l10n.playlistEditorSelectImage,
          ...
          _LabeledTextField(
            label: l10n.playlistEditorNameLabel,
            controller: _nameController,
            hintText: l10n.playlistEditorNamePlaceholder,
          ...
          const SizedBox(height: 12),
          _LabeledTextField(
            label: l10n.playlistEditorDescriptionLabel,
            controller: _descriptionController,
            hintText: l10n.playlistEditorDescriptionPlaceholder,
            maxLines: 3,
            enabled: !state.isProcessing,
            labelColor: labelColor,
            textColor: fieldTextColor,
      ...
      actions: [
        ...
        if (isEditing)
          _SheetActionButton.secondary(
            label: l10n.playlistEditorDeleteButton,
            onPressed: state.isProcessing
                ? null
  ...
  Future<void> _handleSubmit(PlaylistsCubit playlistsCubit) async {
    ...
    if (name.isEmpty) {
      setState(() {
        _error = context.l10n.playlistEditorNameRequired;
      });
      return;
    }
    ...
    if (widget.isEditing) {
      ...
      if (!success) {
        setState(() {
          _error = playlistsCubit.state.errorMessage ??
              context.l10n.playlistEditorSaveFailed;
        });
        return;
      }
    ...
    if (newId == null) {
      setState(() {
        _error = playlistsCubit.state.errorMessage ??
            context.l10n.playlistEditorCreateFailed;
      });
      return;
    }
  ...
  Future<void> _handleDelete(PlaylistsCubit playlistsCubit) async {
    ...
    if (!success) {
      setState(() {
        _error = playlistsCubit.state.errorMessage ??
            context.l10n.playlistEditorDeleteFailed;
      });
      return;
    }
  ...
  Future<bool?> _confirmDeleteDialog(
    ...
    final body = Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text(
          l10n.playlistEditorDeleteConfirmTitle(playlistName),
        ...
        const SizedBox(height: 8),
        Text(
          l10n.playlistEditorDeleteConfirmMessage,
          textAlign: TextAlign.center,
          style:
              theme.textTheme.bodySmall?.copyWith(
                color: isDark
    ...
    return showPlaylistModalDialog<bool?>(
      ...
      builder: (_) => _PlaylistModalScaffold(
        title: l10n.playlistEditorDeleteDialogTitle,
        body: body,
        actions: actions,
        maxWidth: 320,
        contentSpacing: 20,
